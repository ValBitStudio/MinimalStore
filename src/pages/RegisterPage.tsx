...
const RegisterPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      login({ email: 'nuevo@usuario.com', name: 'Nuevo Usuario' }); // Auto-login simulado
  ...
  return (
    <div className="fixed inset-0 z-40 bg-stone-100 flex flex-col items-center justify-center font-serif text-stone-800">
      <Helmet>
        <title>Registrarse | MinimalStore</title>
      </Helmet>
        ...
        {!isUnlocked && (
          ...
          >
            <div className="text-center space-y-2">
              ...
              <p className="text-xs tracking-[0.2em] text-stone-400 uppercase">Nuevo Registro</p>
            </div>
        ...
        {isUnlocked && (
          ...
          >
            <div className="w-full max-w-sm px-8">
              ...
              >
                <h2 className="text-4xl font-bold mb-2 text-stone-900">Crear Cuenta</h2>
                <p className="text-stone-500 text-sm italic">Únete a nuestra comunidad</p>
              </motion.div>
              ...
              >
                <Link to="/login" className="text-xs text-stone-400 hover:text-stone-900 transition-colors border-b border-transparent hover:border-stone-900 pb-0.5 tracking-wide font-sans">
